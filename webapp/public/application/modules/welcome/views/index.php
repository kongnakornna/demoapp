...
<body class=" body-marketing body-gradient">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <nav class="navbar-nav ms-auto">
                    <div class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url();?>"><span
                    ...
                    <div class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>"><span class="nav-link-title">Text</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>"><span class="nav-link-title">App</span></a>
                    </div>
                    <div class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>"><span class="nav-link-title">IoT
                                Sulution</span></a>
                    </div>
                    <div class="nav-item ms-4">
                        <a href="<?php echo base_url('demo');?>" class="btn btn-primary">Demo now</a>
                    </div>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="my-5">
                <div class="row g-3 justify-content-center">
                    ...
                    <div class="col-auto">
                        <a href="#" class="btn btn-lg btn-primary" target="_blank" rel="noopener noreferrer">Preview
                            template</a>
                    </div>
                </div>
            </div>
            <div class="hero-img img-overlap-margin">
                <div class="browser">
                    ...
                    <picture>
                        <img src="<?php echo base_url('assets');?>/static/marketing/preview.png"
                            srcset="<?php echo base_url('assets');?>/static/marketing/preview.png 1x, <?php echo base_url('assets');?>/static/marketing/preview@2x.png 2x"
                            alt="" class="img-fluid " width="1040" height="760" loading="lazy">
                    </picture>
    ...
    <section class="section section-light mt-n12 pt-12">
        ...
        <svg class="section-divider" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 28"
        ...
        <div class="container">
            ...
            <div class="row g-8 align-items-center justify-content-center">
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="188" height="28"
                ...
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="57" height="27"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="157" height="28"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="106" height="28"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="89" height="30"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="94" height="41"
                            xmlns="http://www.w3.org/2000/svg">
                            <g fill-rule="nonzero" fill="none">
                                ...
                                <path
                                    ...
                                    stroke="currentColor" stroke-width=".515" fill="#FFF" />
                                <path stroke="currentColor" stroke-width=".515" fill="#FFF"
                                    d="M11.85 8.059l-.262 26.85.624.209.79-23.725 5.645-1.22z" />
                                <path
                ...
                <div class="col-auto"><a href="#" class="link-secondary"><svg width="91" height="30"
                            xmlns="http://www.w3.org/2000/svg">
                            <g fill="currentColor" fill-rule="evenodd">
                                <path
    ...
    <section class="section section-light">
        ...
        <div class="container">
            <div class="section-header">
                ...
                <div class="section-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
    ...
    <section class="section">
        <div class="container-narrow text-center">
            ...
            <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, ipsa? Voluptates
                sunt, ipsum esse quis obcaecati atque placeat consectetur beatae, tenetur ducimus iure minima expedita
                recusandae doloribus nam. Pariatur, facilis?</p>
