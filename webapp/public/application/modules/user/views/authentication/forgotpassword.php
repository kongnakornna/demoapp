...
<body>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="<?php echo base_url('user/forgotpassworddb');?>" method="post"
                autocomplete="off">
                <div class="card-body">
                    <h2 class="card-title text-center mb-4"><?php echo $forgot;?></h2>
                    ...
                    <div class="form-footer">
                        <button type="submit" class="btn btn-primary w-100"><?php echo $sendemail;?></button>
                    </div>
                </div>
            </form>
            <div class="text-center text-secondary mt-3">
                Forget it, <a href="<?php echo base_url('user/signin');?>">send me back</a> to the sign in
                screen.
            </div>
