...
<body>
        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <?php  #############Reset password############## ?>
                    <?php  #############Reset password############## ?>
                    <form action="<?php echo base_url('/user/resetdb');?>" method="post" autocomplete="off"
                        onsubmit="return validatePasswordReset()" novalidate>
                        <div class="mb-3">
                            <label class="form-label">Username / Email</label>
                            <div><?php echo htmlspecialchars($email_user); ?></div>
                            <input type="hidden" name="code" value="<?php echo htmlspecialchars($code); ?>">
                            <input type="hidden" name="email" value="<?php echo htmlspecialchars($email_user); ?>">
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="input-group input-group-flat">
                                ...
                                <span class="input-group-text">
                                    <a href="#" class="link-secondary" title="แสดงรหัสผ่าน"
                            ...
                            <div class="input-group input-group-flat mt-2">
                                <input type="password" name="confirm_password" class="form-control"
                                    placeholder="ยืนยันรหัสผ่าน" autocomplete="new-password" required minlength="8">
                                <span class="input-group-text">
                                    <a href="#" class="link-secondary" title="แสดงรหัสผ่าน"
                                        onclick="togglePassword(this)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="text-center text-secondary mt-3">
                Don't have account yet? <a href="<?php echo base_url('user/signup');?>" tabindex="-1">Sign
                    up</a>
            </div>
    ...
    function validatePasswordReset() {
        ...
        if (!password || !confirmPassword) {
            errorMessage +=
                'กรุณากรอกรหัสผ่านและยืนยันรหัสผ่าน / Please enter your password and confirm your password.\n';
            isValid = false;
        }
        ...
        //     errorMessage +=
        //         'รหัสผ่านต้องประกอบด้วย: ตัวพิมพ์เล็ก, ตัวพิมพ์ใหญ่, ตัวเลข และอักขระพิเศษ /Password must contain: lowercase, uppercase, numbers and special characters. \n';
        //     isValid = false;
        // }
        ...
        if (password !== confirmPassword) {
            errorMessage +=
                'รหัสผ่านและการยืนยันรหัสผ่านไม่ตรงกัน / Password and password confirmation do not match.\n';
            isValid = false;
        }
