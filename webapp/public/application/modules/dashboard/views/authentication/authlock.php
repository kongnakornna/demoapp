...
<body>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="<?php echo base_url('user/authlockdb');?>" method="post"
                ...
                <div class="card-body text-center">
                    ...
                    <div class="mb-4">
                        <span class="avatar avatar-xl mb-3"
                            style="background-image: url(<?php echo base_url('assets');?>/img/cmon.png)">

                        </span>

                        <h3>Cmon</h3>
                    </div>
                    <input type="hidden" name="username" placeholder="<?php echo $this->lang->line('username');?>"
