    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-flat">
                            ...
                            <input type="confirm_password" name="confirm_password" value="" class="form-control"
                    ...
                    <div class="mb-3">
                        <label class="form-check">
                            ...
                            <span class="form-check-label">Agree the <a
                                    href="<?php echo base_url('assets');?>/terms-of-service.html" tabindex="-1">terms
                                    and policy</a>.</span>
                        </label>
                    </div>
            ...
            <div class="text-center text-secondary mt-3">
                Already have account? <a href="<?php echo base_url('user/signin');?>" tabindex="-1">Sign in</a>
            </div>
