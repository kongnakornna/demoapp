...
<body>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="<?php echo base_url('user/verifyotpapp');?>" method="post"
                autocomplete="off" novalidate>
                <div class="card-body">
                    <h2 class="card-title card-title-lg text-center mb-4">Authenticate Your Account</h2>
                    
                    <p class="my-4 text-center">Please confirm your account by entering the authorization <br>code sent
                        to
                        <strong>
                            <b><?php echo $tokenkey;?></b>
                        </strong>.
                    </p>
                    ...
                    <div class="my-5">
                        <div class="row g-4">
                            ...
                            <input type="hidden" id="otpkey" name="otpkey" class="form-control"
                                value="<?php echo $tokenkey;?>" autocomplete="off">
                            <input type="text" id="otp" name="otp" class="form-control" value="<?php echo $otp;?>"
        ...
        <div class="text-center text-secondary mt-3">
            It may take a minute to receive your code. Haven't received it? <a
                href="<?php echo base_url('user/signin2');?>">Resend a new code.</a>
        </div>
