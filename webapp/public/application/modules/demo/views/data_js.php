...
document.addEventListener("DOMContentLoaded", function() {
    ...
    window.ApexCharts && (window.tabler_chart["chart-visitors"] = new ApexCharts(document
        .getElementById('chart-visitors'), {
            chart: {
                type: "line",
                fontFamily: 'inherit',
                height: 96,
            ...
            series: [{
                name: "Visitors",
                data: [7687, 7543, 7545, 7543, 7635, 8140, 7810, 8315, 8379, 8441, 8485,
                    8227, 8906, 8561, 8333, 8551, 9305, 9647, 9359, 9840, 9805,
                    8612, 8970, 8097, 8070, 9829, 10545, 10754, 10270, 9282
                ]
            }, {
                name: "Visitors last month",
                data: [8630, 9389, 8427, 9669, 8736, 8261, 8037, 8922, 9758, 8592, 8976,
                    9459, 8125, 8528, 8027, 8256, 8670, 9384, 9813, 8425, 8162,
                    8024, 8897, 9284, 8972, 8776, 8121, 9476, 8281, 9065
                ]
            }],
            tooltip: {
                theme: 'dark'
