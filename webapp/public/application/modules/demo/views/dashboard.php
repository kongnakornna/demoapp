    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="h2 subheader">Podium floor 7</div>
                        <?php #################?>
                        ...
                        <?php #################?>
                        <div id="chart-active-users-top-1" class="position-relative "></div>
                        <div class="d-flex align-items-baseline">
            ...
            <!--- chart-active-users-top-->
            <script>
            document.addEventListener("DOMContentLoaded", function() {
                window.tabler_chart = window.tabler_chart || {};
                window.ApexCharts && (window.tabler_chart["chart-active-users-top-1"] = new ApexCharts(document
                    .getElementById('chart-active-users-top-1'), {
                        chart: {
                            type: "radialBar",
                            fontFamily: 'inherit',
                            height: 192,
            ...
            function fetchAndUpdateChart() {
                fetch('http://localhost:88/cmonphpiot/api/iot')
                    .then(res => res.json())
                    .then(data => {
                        const measurement = data.payload[0].measurement;
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php #################?>
                        <div id="chart-fan-1" class="position-relative "></div>
                        <div class="d-flex align-items-baseline">
            ...
            document.addEventListener("DOMContentLoaded", function() {
                window.tabler_chart = window.tabler_chart || {};
                window.ApexCharts && (window.tabler_chart["chart-fan-1"] = new ApexCharts(document
                    .getElementById('chart-fan-1'), {
                        chart: {
                            type: "radialBar",
                            fontFamily: 'inherit',
                            height: 192,
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="h2 subheader">Podium floor 8 </div>
                        <?php #################?>
                        <div class="page-header d-print-none">
                            <div class="container">
                                <div class="row g-3 align-items-center">
                        ...
                        <?php #################?>
                        <div id="chart-fan-2" class="position-relative "></div>
                        <div class="d-flex align-items-baseline">
            ...
            document.addEventListener("DOMContentLoaded", function() {
                window.tabler_chart = window.tabler_chart || {};
                window.ApexCharts && (window.tabler_chart["chart-fan-2"] = new ApexCharts(document
                    .getElementById('chart-fan-2'), {
                        chart: {
                            type: "radialBar",
                            fontFamily: 'inherit',
                            height: 192,
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="h2 subheader">Podium floor 11</div>
                        <?php #################?>
                        <div class="page-header d-print-none">
                            <div class="container">
                                <div class="row g-3 align-items-center">
                        ...
                        <?php #################?>
                        <div id="chart-fan-3" class="position-relative "></div>
                        <div class="d-flex align-items-baseline">
            ...
            document.addEventListener("DOMContentLoaded", function() {
                window.tabler_chart = window.tabler_chart || {};
                window.ApexCharts && (window.tabler_chart["chart-fan-3"] = new ApexCharts(document
                    .getElementById('chart-fan-3'), {
                        chart: {
                            type: "radialBar",
                            fontFamily: 'inherit',
                            height: 192,
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="h2 subheader">Podium floor 12</div>
                        <?php #################?>
                        <div class="page-header d-print-none">
                            <div class="container">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">
                                            <ul class="list-inline list-inline-dots mb-0">
                                                <li class="list-inline-item"><span class="text-red">Critical
                                                        warning!</span></li>
                                                <li class="list-inline-item">Checked every 1 minutes</li>
                                            </ul>
                                        </div>
...
<?php 
    // Data  api
    $this->load->view('demo/data_js_v1');
