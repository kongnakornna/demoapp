<!-- BEGIN PAGE BODY -->
<?php   $this->load->view('dashboard/pagewrapper_seeting'); ?>
<div class="page-body">
    <?php 
    /*****body**********/
    ?>
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php #################?>
                        <div id="chart-active-users-top" class="position-relative "></div>
                        <div class="d-flex align-items-baseline">
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                window.ApexCharts && (window.tabler_chart["chart-active-users-top"] = new ApexCharts(document
                    .getElementById('chart-active-users-top'), {
                        chart: {
                            type: "radialBar",
                            fontFamily: 'inherit',
                            height: 192,
                                ...
                                dataLabels: {
                                    ...
                                    value: {
                                        ...
                                        formatter: function(val) {
                                            return val + "°C"; // เปลี่ยนหน่วยเป็น °C
                                        }
                                    }
                                },
                            },
...
<?php 
    // Data  api
    $this->load->view('home/data_js_v1');
