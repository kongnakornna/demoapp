...
<head>
    ...
    <link href="<?php echo base_url('assets');?>/dist/css/tabler.css?1747120848" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PLUGINS STYLES -->
    <link href="<?php echo base_url('assets');?>/dist/css/tabler-flags.css?1747120849" rel="stylesheet" />
    <link href="<?php echo base_url('assets');?>/dist/css/tabler-socials.css?1747120849" rel="stylesheet" />
    <link href="<?php echo base_url('assets');?>/dist/css/tabler-payments.css?1747120849" rel="stylesheet" />
    <link href="<?php echo base_url('assets');?>/dist/css/tabler-vendors.css?1747120849" rel="stylesheet" />
    <link href="<?php echo base_url('assets');?>/dist/css/tabler-marketing.css?1747120849" rel="stylesheet" />
    <link href="<?php echo base_url('assets');?>/dist/css/tabler-themes.css?1747120849" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->

    <!-- BEGIN DEMO STYLES -->
    <link href="<?php echo base_url('assets');?>/preview/css/demo.css?1747120849" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    ...
    <div class="page page-center">
        <div class="container-tight py-4">
            ...
            <div class="empty">
                ...
                <div class="empty-img"><svg class="img" xmlns="http://www.w3.org/2000/svg" height="256" fill="none"
                        viewBox="0 0 800 600">
                        <style>
                ...
                <div class="empty-action">
                    ...
                    <a href="<?php echo base_url('maintenance');?>" class="btn btn-primary btn-4">
